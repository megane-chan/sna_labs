...
-   ChatGPT, an AI-powered knowledge-base
...
For this lab, you will collect text from one or more crowdsourced knowledge-bases and ChatGPT, save the data from the search, create networks from the data, and compare the differences among networks. To begin, complete the following three steps:

1.  Choose a topic for your text: \[ENTER TOPIC NAME HERE\]
...
2.  Collect text related to this topic:
    ...
    For the collective intelligence source (e.g., Wikipedia, Reddit, Stack Exchange, Quora, etc.), you should find a single webpage that contains an overview of your topic. For ChatGPT, you should ask it to generate an overview of your topic.
...
3.  Finally, copy/paste the information from both types of sources in the corresponding .txt files in your current working directory (the same folder that this code file is in on your computer): copy/paste the replies from ChatGPT into the 'chatgpt.txt' file and copy/paste the text from a collective intelligence source (e.g., Wikipedia) into the 'human.txt' file. Do not forget to save the files after pasting.
...
######################################################################################
# Load your Text Files into R
######################################################################################

# start by reading in the artificial intelligence text file and storing it as a variable
gpt_text <- read_file("chatgpt.txt")
# view the text you imported to make sure it's what you're expecting it to be
print(c(gpt_text))

# repeat for the collective intelligence source
...
gpt_comp <- igraph::components(gpt_graph); gpt_comp
